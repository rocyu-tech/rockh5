...
func registerRoutes(app *fiber.App) {
        ...
        authenticated.Get("/user-tags", placeholder("user-tags"))
        authenticated.Post("/create", placeholder("create"))
        authenticated.Post("/group", placeholder("group"))
        authenticated.Post("/match", placeholder("match"))
        authenticated.Post("/refresh", placeholder("refresh"))
}
