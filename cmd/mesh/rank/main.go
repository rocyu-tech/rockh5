...
func registerRoutes(app *fiber.App) {
        ...
        authenticated.Get("/my-rank", placeholder("my-rank"))
        authenticated.Get("/top", placeholder("top"))
        authenticated.Get("/snapshot", placeholder("snapshot"))
}
