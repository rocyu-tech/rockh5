...
func registerRoutes(app *fiber.App) {
        ...
        authenticated.Get("/daily", placeholder("daily"))
        authenticated.Get("/weekly", placeholder("weekly"))
        authenticated.Get("/growth", placeholder("growth"))
        authenticated.Get("/progress", placeholder("progress"))
        authenticated.Post("/claim", placeholder("claim"))
}
