...
func registerRoutes(app *fiber.App) {
        ...
        authenticated.Get("/inventory", placeholder("inventory"))
        authenticated.Post("/use", placeholder("use"))
        authenticated.Post("/transfer", placeholder("transfer"))
        authenticated.Get("/list", placeholder("list"))
        authenticated.Post("/grant", placeholder("grant"))
}
