...
func registerRoutes(app *fiber.App) {
        ...
        authenticated.Get("/inbox", placeholder("inbox"))
        authenticated.Post("/send", placeholder("send"))
        authenticated.Post("/read", placeholder("read"))
        authenticated.Post("/claim-attachment", placeholder("claim-attachment"))
        authenticated.Get("/unread-count", placeholder("unread-count"))
}
